#include <anahita_plugins/cameraPlugin.hh>

namespace gazebo
{
  // Register this plugin with the simulator
  GZ_REGISTER_SENSOR_PLUGIN(AnahitaCameraPlugin)

  AnahitaCameraPlugin::AnahitaCameraPlugin()
  {
  ...
  void AnahitaCameraPlugin::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
  {
    ...
    this->topic_name_ = "/anahita/camera/data";
  ...
  void AnahitaCameraPlugin::myMemCpy(void *dest, std::string &new_image, size_t n)
  {
  ...
  void AnahitaCameraPlugin::OnNewFrame(const unsigned char *_image, unsigned int _width, 
